...
const DashboardPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-xl p-6 text-white shadow-lg flex flex-col md:flex-row items-center justify-between gap-6">
        <div>
           <h3 className="text-xl font-bold mb-2">Your Game is Live!</h3>
           <p className="text-slate-300 text-sm max-w-md">Share this link with your customers or display it on a tablet at your venue to start collecting leads.</p>
        </div>
